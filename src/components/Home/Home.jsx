        ...
        <div>
            <Row style={{ textAlign: 'center', marginTop: '80px', alignItems: 'center', justifyContent: 'center', margin: 0, padding: '80px 20px 20px 20px' }}>
                ...
                <Col lg="7">
                    ...
                    <h5>Are you a travel enthusiast seeking inspiration for your next adventure? Look no further! Way Vista is your go-to destination for immersive travel experiences, hidden gems, and insider tips on the world's most breathtaking tourist spots.</h5>
                </Col>
            </Row>
